  ...
  filtered.forEach((p, i) => {
    ...
    card.innerHTML = `
      <div class="product-img-wrap">
        <div class="product-emoji-img" style="height: 180px; overflow: hidden;">${p.image ? "<img src='" + p.image +"' style='width:100%;height:100%;object-fit:cover; border-radius:10px;'>" : p.emoji}</div>
